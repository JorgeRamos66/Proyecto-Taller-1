        ...
        <div class="col-lg-6">
            <div class="informacion rounded-2 my-2 text-justify text-wrap" style="backdrop-filter: blur(10px); background-color: rgb(255, 255, 255, 0.2);">
                ...
                <ul>
                  ...
                  <li>Promociones y descuentos: Aprovecha nuestras ofertas especiales y descuentos.</li>
                  <li>Preguntas frecuentes: Encuentra respuestas a tus dudas en nuestra sección de preguntas frecuentes.</li>
                </ul>
              </div>
